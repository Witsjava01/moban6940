  ...
  <main class="main oh" id="main">
    ...
    <div class="section-wrap">
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-6">
            <h1 class="uppercase mb-20">delivery questions</h1>

            <!-- Accordion -->
            <div class="accordion mb-50" id="accordion">
              <div class="accordion__panel">
                <div class="accordion__heading" id="headingOne">
                  <a data-toggle="collapse" href="#collapseOne" class="accordion__link accordion--is-open" aria-expanded="true" aria-controls="collapseOne">HOW TO TRACK MY DELIVERY?<span class="accordion__toggle">&nbsp;</span>
                  </a>
                </div>
                <div id="collapseOne" class="collapse show" data-parent="#accordion" role="tabpanel" aria-labelledby="headingOne">
                  <div class="accordion__body">
                    Namira is a very slick and clean e-commerce template with endless possibilities. An awesome clothes store with this Theme is easy than you can imagine. Our Theme is a very slick and clean e-commerce template. Nullam ac dapibus nisi. Donec placerat mattis justo a eleifend.
                  </div>
                </div>
              </div>
              ...
              <div class="accordion__panel">
                <div class="accordion__heading" id="headingTwo">
                  <a data-toggle="collapse" href="#collapseTwo" class="accordion__link accordion--is-closed" aria-expanded="false" aria-controls="collapseTwo">WHERE CAN I FIND TRACKING NUMBER?<span class="accordion__toggle">&nbsp;</span>
                  </a>
                </div>
              ...
              <div class="accordion__panel">
                <div class="accordion__heading" id="headingThree">
                  <a data-toggle="collapse" href="#collapseThree" class="accordion__link accordion--is-closed" aria-expanded="false" aria-controls="collapseThree">WHAT DELIVERY METHODS CAN I USE?<span class="accordion__toggle">&nbsp;</span>
                  </a>
                </div>
              ...
              <div class="accordion__panel">
                <div class="accordion__heading" id="headingFour">
                  <a data-toggle="collapse" href="#collapseFour" class="accordion__link accordion--is-closed" aria-expanded="false" aria-controls="collapseFour">What i have to do when i need your support?<span class="accordion__toggle">&nbsp;</span>
                  </a>
                </div>
              ...
              <div class="accordion__panel">
                <div class="accordion__heading" id="headingFive">
                  <a data-toggle="collapse" href="#collapseFive" class="accordion__link accordion--is-closed" aria-expanded="false" aria-controls="collapseFive">do you offer customization services?<span class="accordion__toggle">&nbsp;</span>
                  </a>
                </div>
          ...
          <div class="col-lg-6">
            <h1 class="uppercase mb-20">payment questions</h1>

            <!-- Accordion -->
            <div class="accordion mb-50" id="accordion-1">
              <div class="accordion__panel">
                <div class="accordion__heading" id="accordion-1__headingOne">
                  <a data-toggle="collapse" href="#accordion-1__collapseOne" class="accordion__link accordion--is-open" aria-expanded="true" aria-controls="accordion-1__collapseOne">WHAT PAYMENT METHODS DO YOU ACCEPT?<span class="accordion__toggle">&nbsp;</span>
                  </a>
                </div>
                <div id="accordion-1__collapseOne" class="collapse show" data-parent="#accordion-1" role="tabpanel" aria-labelledby="accordion-1__headingOne">
                  <div class="accordion__body">
                    Namira is a very slick and clean e-commerce template with endless possibilities. An awesome clothes store with this Theme is easy than you can imagine. Our Theme is a very slick and clean e-commerce template. Nullam ac dapibus nisi. Donec placerat mattis justo a eleifend.
                  </div>
                </div>
              ...
              <div class="accordion__panel">
                <div class="accordion__heading" id="accordion-1__headingTwo">
                  <a data-toggle="collapse" href="#accordion-1__collapseTwo" class="accordion__link accordion--is-closed" aria-expanded="false" aria-controls="accordion-1__collapseTwo">HOW TO PAY VIA CREDIT CARD?<span class="accordion__toggle">&nbsp;</span>
                  </a>
                </div>
                <div id="accordion-1__collapseTwo" class="collapse" data-parent="#accordion-1" role="tabpanel" aria-labelledby="accordion-1__headingTwo">
                  <div class="accordion__body">
                    Namira is a very slick and clean e-commerce template with endless possibilities. An awesome clothes store with this Theme is easy than you can imagine. Our Theme is a very slick and clean e-commerce template. Nullam ac dapibus nisi. Donec placerat mattis justo a eleifend.
                  </div>
                </div>
              ...
              <div class="accordion__panel">
                <div class="accordion__heading" id="accordion-1__headingThree">
                  <a data-toggle="collapse" href="#accordion-1__collapseThree" class="accordion__link accordion--is-closed" aria-expanded="false" aria-controls="accordion-1__collapseThree">WHAT CREDIT CARDS DO YOU ACCEPT?<span class="accordion__toggle">&nbsp;</span>
                  </a>
                </div>
                <div id="accordion-1__collapseThree" class="collapse" data-parent="#accordion-1" role="tabpanel" aria-labelledby="accordion-1__headingThree">
                  <div class="accordion__body">
                    Namira is a very slick and clean e-commerce template with endless possibilities. An awesome clothes store with this Theme is easy than you can imagine. Our Theme is a very slick and clean e-commerce template. Nullam ac dapibus nisi. Donec placerat mattis justo a eleifend.
                  </div>
                </div>
              ...
              <div class="accordion__panel">
                <div class="accordion__heading" id="accordion-1__headingFour">
                  <a data-toggle="collapse" href="#accordion-1__collapseFour" class="accordion__link accordion--is-closed" aria-expanded="false" aria-controls="accordion-1__collapseFour">HOW TO PAY VIA PAYPAL?<span class="accordion__toggle">&nbsp;</span>
                  </a>
                </div>
                <div id="accordion-1__collapseFour" class="collapse" data-parent="#accordion-1" role="tabpanel" aria-labelledby="accordion-1__headingFour">
                  <div class="accordion__body">
                    Namira is a very slick and clean e-commerce template with endless possibilities. An awesome clothes store with this Theme is easy than you can imagine. Our Theme is a very slick and clean e-commerce template. Nullam ac dapibus nisi. Donec placerat mattis justo a eleifend.
                  </div>
                </div>
              ...
              <div class="accordion__panel">
                <div class="accordion__heading" id="accordion-1__headingFive">
                  <a data-toggle="collapse" href="#accordion-1__collapseFive" class="accordion__link accordion--is-closed" aria-expanded="false" aria-controls="accordion-1__collapseFive">What is your return policy?<span class="accordion__toggle">&nbsp;</span>
                  </a>
                </div>
                <div id="accordion-1__collapseFive" class="collapse" data-parent="#accordion-1" role="tabpanel" aria-labelledby="accordion-1__headingFive">
                  <div class="accordion__body">
                    Namira is a very slick and clean e-commerce template with endless possibilities. An awesome clothes store with this Theme is easy than you can imagine. Our Theme is a very slick and clean e-commerce template. Nullam ac dapibus nisi. Donec placerat mattis justo a eleifend.
                  </div>
                </div>
